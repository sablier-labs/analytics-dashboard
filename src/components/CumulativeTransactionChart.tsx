...
export const CumulativeTransactionChart = memo(function CumulativeTransactionChart() {
  ...
  const chartData = useMemo(() => {
    if (!transactionData) return { datasets: [], labels: [] };
  ...
  }, [transactionData, theme, formatMonth]);
