...
export const MedianClaimWindow = memo(function MedianClaimWindow() {
    ...
    return (
      <div className="bg-white dark:bg-bg-secondary rounded-xl border border-border-default shadow-lg p-6 transition-all duration-200 ">
        <div className="animate-pulse">
          ...
          <div className="h-8 bg-bg-tertiary dark:bg-surface-hover rounded w-20"></div>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="bg-white dark:bg-bg-secondary rounded-xl border border-red-300 dark:border-red-600 shadow-lg p-6 transition-all duration-200 ">
        <p className="text-sm text-red-600 dark:text-red-400 mb-2">
          Error loading median claim window
        </p>
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <p className="text-sm font-medium text-text-secondary">Median Claim Window</p>
          <SourceCodeLink
