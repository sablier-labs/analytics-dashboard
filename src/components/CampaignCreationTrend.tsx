...
export const CampaignCreationTrend = memo(function CampaignCreationTrend() {
  ...
  const chartData = useMemo(() => {
    if (!campaignData) return { datasets: [], labels: [] };
        ...
        tooltip: {
          ...
          callbacks: {
            ...
            title: (context: TooltipItem<"line">[]) => {
              ...
              return campaignData ? campaignData[dataIndex].month : "";
            },
          },
          cornerRadius: 6,
          displayColors: false,
